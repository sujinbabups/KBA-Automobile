...
2024-09-27T16:54:19.856Z info [c-api:lib/handler.js]                              Creating new Chaincode Support Client for peer comminications  
2024-09-27T16:54:19.859Z info [c-api:lib/chaincode.js]                            Registering with peer localhost:7051 as chaincode "mycc"  
      ✓ should start when passed init and invoke
2024-09-27T16:54:19.872Z info [c-api:lib/chaincode.js]                            Registering with peer localhost:7051 as chaincode "mycc"  
...
2024-09-27T16:54:19.943Z info [c-api:lib/handler.js]                              Creating new Chaincode Support Client for peer comminications  
2024-09-27T16:54:19.944Z info [c-api:lib/chaincode.js]                            Registering with peer localhost:7051 as chaincode "mycc"  
        ✓ should call handler.chat() with the correct object and output a message
2024-09-27T16:54:19.958Z info [c-api:lib/chaincode.js]                            Registering with peer localhost:7051 as chaincode "mycc"  
        ✓ should load the opts certificate attributes as JSON strings with the correct properties
    parsePeerUrlFcn
2024-09-27T16:54:19.966Z error [c-api:lib/chaincode.js]                           The "peer.address" program argument must be set to a legitimate value of <host>:<port>  
      ✓ should throw an error if peer.address not set
2024-09-27T16:54:19.971Z error [c-api:lib/chaincode.js]                           The "peer.address" program argument can not be set to an "http(s)" url, use grpc(s) or omit the protocol  
...
2024-09-27T16:54:20.044Z info [c-api:fabric-shim/cli]                             Bootstrap process completed  
      ✓ should handle resolved promise  correctly
2024-09-27T16:54:20.067Z info [c-api:fabric-shim/cli]                             Bootstrap process completed  
...
(node:2486) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 uncaughtException listeners added to [process]. Use emitter.setMaxListeners() to increase limit
...
2024-09-27T16:54:20.918Z info [c-api:contracts-spi/bootstrap.js]                  No metadata file supplied in contract, introspection will generate all the data  
      ✓ should handle when files not available
    #loadAndValidateMetadata
      ✓ validate and return the metadata (38ms)
...
<Buffer 44 65 66 61 75 6c 74 20 69 6e 69 74 69 61 74 6f 72 20 73 75 63 63 65 73 73 66 75 6c 2e>
    ...
    #invokeFunctionality
2024-09-27T16:54:21.276Z error [c-api:contracts-spi/chaincodefromcontract.js]     a logging prefix Error: Contract name is not known: name  
...
2024-09-27T16:54:21.386Z error [c-api:contracts-spi/datamarshall.js]              undefined Expected 1 parameters, but 0 have been supplied  
...
2024-09-27T16:54:21.426Z error [c-api:lib/handler.js]                             Failed to find a message for transaction context id theChannelIDaTX  
...
2024-09-27T16:54:21.434Z info [c-api:lib/handler.js]                              Creating new Chaincode Support Client for peer comminications  
      ✓ should set endpoint, client and default timeout
2024-09-27T16:54:21.435Z info [c-api:lib/handler.js]                              Creating new Chaincode Support Client for peer comminications  
      ✓ should override the default request timeout if value passed
2024-09-27T16:54:21.435Z info [c-api:lib/handler.js]                              Creating new Chaincode Support Client for peer comminications  
      ✓ should store additional grpc options
2024-09-27T16:54:21.436Z info [c-api:lib/handler.js]                              Creating new Chaincode Support Client for peer comminications  
      ...
      ✓ should throw an error if connection secure encoded private key not passed as opt
2024-09-27T16:54:21.441Z info [c-api:lib/handler.js]                              Creating new Chaincode Support Client for peer comminications  
      ✓ should set endpoint, client and default timeout for a secure connection
2024-09-27T16:54:21.446Z info [c-api:lib/handler.js]                              Creating new Chaincode Support Client for peer comminications  
      ✓ should set grpc ssl options when ssl-target-name-override passed
      close
2024-09-27T16:54:21.447Z info [c-api:lib/handler.js]                              Creating new Chaincode Support Client for peer comminications  
        ✓ should call end on the stream
      chat
2024-09-27T16:54:21.449Z info [c-api:lib/handler.js]                              Creating new Chaincode Support Client for peer comminications  
        ✓ should create an instance of ChaincodeMessageHandler and pass the argument
      toString
2024-09-27T16:54:21.463Z info [c-api:lib/handler.js]                              Creating new Chaincode Support Client for peer comminications  
    ...
    ChaincodeMessageHandler
      chat
        ...
        stream.on.data
2024-09-27T16:54:21.481Z error [c-api:lib/handler.js]                             Chaincode is in "created" state, can only process messages of type "registered", but received "NOT REGISTERED"  
          ✓ should throw error when in state created and MSG_TYPE not REGISTERED
2024-09-27T16:54:21.506Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2024-09-27T16:54:21.506Z error [c-api:lib/handler.js]                             Chaincode is in "established" state, can only process messages of type "ready", but received "NOT REGISTERED"  
          ✓ should throw error when in state established and MSG_TYPE not READY
2024-09-27T16:54:21.521Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2024-09-27T16:54:21.522Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should do nothing when in state ready and MSG_TYPE equals REGISTERED
2024-09-27T16:54:21.537Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2024-09-27T16:54:21.537Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should do nothing when in state ready and MSG_TYPE equals READY
2024-09-27T16:54:21.559Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2024-09-27T16:54:21.560Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should call handleMsgResponse when in state ready and MSG_TYPE equals RESPONSE
2024-09-27T16:54:21.573Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2024-09-27T16:54:21.574Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should call handleMsgResponse when in state ready and MSG_TYPE equals ERROR
2024-09-27T16:54:21.586Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2024-09-27T16:54:21.586Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should call handleInit when in state ready and MSG_TYPE equals INIT
2024-09-27T16:54:21.603Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2024-09-27T16:54:21.603Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should call handleTransaction when in state ready and MSG_TYPE equals TRANSACTION
2024-09-27T16:54:21.622Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2024-09-27T16:54:21.622Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
2024-09-27T16:54:21.622Z error [c-api:lib/handler.js]                             Received unknown message from the peer. Exiting.  
          ✓ should end the process with value 1
        stream.on.end
          ✓ should cancel the stream
        stream.on.error
2024-09-27T16:54:21.645Z error [c-api:lib/handler.js]                             Chat stream with peer - on error: %j {} 
          ✓ should end the stream
2024-09-27T16:54:21.657Z error [c-api:lib/handler.js]                             Chat stream with peer - on error: %j "Error\n    at Context.<anonymous> (/home/runner/work/fabric-chaincode-node/fabric-chaincode-node/libraries/fabric-shim/test/unit/handler.js:857:35)\n    at callFn (/home/runner/work/fabric-chaincode-node/fabric-chaincode-node/common/temp/node_modules/.pnpm/mocha@9.1.3/node_modules/mocha/lib/runnable.js:366:21)\n    at Runnable.run (/home/runner/work/fabric-chaincode-node/fabric-chaincode-node/common/temp/node_modules/.pnpm/mocha@9.1.3/node_modules/mocha/lib/runnable.js:354:5)\n    at Runner.runTest (/home/runner/work/fabric-chaincode-node/fabric-chaincode-node/common/temp/node_modules/.pnpm/mocha@9.1.3/node_modules/mocha/lib/runner.js:681:10)\n    at /home/runner/work/fabric-chaincode-node/fabric-chaincode-node/common/temp/node_modules/.pnpm/mocha@9.1.3/node_modules/mocha/lib/runner.js:804:12\n    at next (/home/runner/work/fabric-chaincode-node/fabric-chaincode-node/common/temp/node_modules/.pnpm/mocha@9.1.3/node_modules/mocha/lib/runner.js:596:14)\n    at /home/runner/work/fabric-chaincode-node/fabric-chaincode-node/common/temp/node_modules/.pnpm/mocha@9.1.3/node_modules/mocha/lib/runner.js:606:7\n    at next (/home/runner/work/fabric-chaincode-node/fabric-chaincode-node/common/temp/node_modules/.pnpm/mocha@9.1.3/node_modules/mocha/lib/runner.js:489:14)\n    at Immediate._onImmediate (/home/runner/work/fabric-chaincode-node/fabric-chaincode-node/common/temp/node_modules/.pnpm/mocha@9.1.3/node_modules/mocha/lib/runner.js:574:5)\n    at process.processImmediate (node:internal/timers:476:21)" 
    ...
    handleMessage
      Error
2024-09-27T16:54:22.094Z error [c-api:lib/handler.js]                             %s Incorrect payload format. Sending ERROR message back to peer "[theChannelID-01234567]" 
        ✓ should handle an error decoding the payload
2024-09-27T16:54:22.097Z error [c-api:lib/handler.js]                             Failed to construct a chaincode stub instance from the INIT message: an error
    at fake.exceptionCreator (/home/runner/work/fabric-chaincode-node/fabric-chaincode-node/common/temp/node_modules/.pnpm/sinon@13.0.1/node_modules/sinon/lib/sinon/default-behaviors.js:18:32)
    at Object.invoke (/home/runner/work/fabric-chaincode-node/fabric-chaincode-node/common/temp/node_modules/.pnpm/sinon@13.0.1/node_modules/sinon/lib/sinon/behavior.js:165:35)
...
2024-09-27T16:54:22.099Z error [c-api:lib/handler.js]                             [theChannelID-01234567] Calling chaincode Init() has not called success or error.  
2024-09-27T16:54:22.099Z error [c-api:lib/handler.js]                             [theChannelID-01234567] Calling chaincode Init() returned error response [[theChannelID-01234567] Calling chaincode Init() has not called success or error.]. Sending COMPLETED message back to peer  
        ✓ should handle chaincode.Init returning nothing
2024-09-27T16:54:22.101Z error [c-api:lib/handler.js]                             [theChannelID-01234567] Calling chaincode Invoke() has not called success or error.  
2024-09-27T16:54:22.101Z error [c-api:lib/handler.js]                             [theChannelID-01234567] Calling chaincode Invoke() returned error response [[theChannelID-01234567] Calling chaincode Invoke() has not called success or error.]. Sending COMPLETED message back to peer  
        ✓ should handle chaincode.Invoke returning nothing
2024-09-27T16:54:22.103Z error [c-api:lib/handler.js]                             [theChannelID-01234567] Calling chaincode Init() has not called success or error.  
2024-09-27T16:54:22.103Z error [c-api:lib/handler.js]                             [theChannelID-01234567] Calling chaincode Init() returned error response [[theChannelID-01234567] Calling chaincode Init() has not called success or error.]. Sending COMPLETED message back to peer  
        ✓ should handle chaincode.Init returning no status
2024-09-27T16:54:22.105Z error [c-api:lib/handler.js]                             [theChannelID-01234567] Calling chaincode Invoke() has not called success or error.  
2024-09-27T16:54:22.106Z error [c-api:lib/handler.js]                             [theChannelID-01234567] Calling chaincode Invoke() returned error response [[theChannelID-01234567] Calling chaincode Invoke() has not called success or error.]. Sending COMPLETED message back to peer  
        ✓ should handle chaincode.Invoke returning no status
      Complete
2024-09-27T16:54:22.109Z info [c-api:lib/handler.js]                              [theChannelID-01234567] Calling chaincode Init() succeeded. Sending COMPLETED message back to peer  
        ✓ should write a COMPLETE message when successful init
2024-09-27T16:54:22.111Z info [c-api:lib/handler.js]                              [theChannelID-01234567] Calling chaincode Invoke() succeeded. Sending COMPLETED message back to peer  
...
2024-09-27T16:54:22.193Z error [c-api:lib/iterators.js]                           unexpected error received getting next value: %s "this.response.getId is not a function" 
  ...
  Logger
    ✓ coverage
2024-09-27T16:54:22.204Z error [c-api:_]                                          Unhandled Rejection reason __PERMITTED__ promise Promise { <rejected> '__PERMITTED__' }  
2024-09-27T16:54:22.204Z error [c-api:_]                                          Unhandled Rejection reason __PERMITTED__ promise Promise { <rejected> '__PERMITTED__' }  
    getLogger
...
2024-09-27T16:54:22.227Z error [c-api:lib/server.js]                              ChaincodeServer failed to bind to 0.0.0.0:9999  
      ✓ should throw if bindAsync fails
    connect()
      ✓ should call connect
2024-09-27T16:54:22.232Z warn [c-api:lib/server.js]                               connection from peer failed: Error: Some error from chat  
